        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 pt-lg-0">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <h1 class="h2">اضافه کردن مطلب جدید</h1>
                </div>
                ...
                <div class="col-md-8 order-md-1 mw-100 p-0">
                    <form class="needs-validation " novalidate method="post" action="AddNewPost.php"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="عنوان" name="txtTitle">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="post">متن</label>
                            <textarea class="form-control" id="post" placeholder="متن" name="txtPost"
                                rows="2"></textarea>
                        </div>
                        <button class="btn btn-success btn-lg btn-block" type="submit" name="btnAddPost">اضافه کن</button>
                    </form>
                </div>
            </main>
        </div>
