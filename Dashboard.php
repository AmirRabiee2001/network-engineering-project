                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < $rowCount; $i++) {
                                ...
                                echo '<td>'
                                    ...
                                    . '<button class="btn btn-warning btn-block" type="submit" name="btnEdit">تغییر</button>'
                                    . '</a>'
                                ...
                                echo '<td>'
                                    ...
                                    . '<button class="btn btn-primary btn-block" type="submit" name="btnPreview">نمایش زنده</button>'
                                    . '</a>' . '</td>';
