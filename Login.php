...
<body class="text-center">
    <form class="form-signin" action="Login.php" method="post">
        ...
        <h1 class="h3 mb-3 font-weight-normal">ورود به پنل</h1>
        <label for="username" class="sr-only">نام کاربری</label>
        <input type="text" id="username" class="form-control" name="txtUsername" placeholder="نام کاربری" required autofocus>
        <label for="inputPassword" class="sr-only">رمز عبور</label>
        <input type="password" id="inputPassword" class="form-control" name="txtPassword" placeholder="رمز عبور" required>
        <div class="checkbox mb-3">
            <label>
                <input type="checkbox" value="remember-me" name="btnRemember"> بخاطر داشته باش
            </label>
        </div>
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="btnSubmit">ورود</button>
    </form>
</body>
